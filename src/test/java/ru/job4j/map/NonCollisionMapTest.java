...
class NonCollisionMapTest {
    ...
    @Test
    void whenCheckPutAndGetNull() {
        SimpleMap<Integer, String> map = new NonCollisionMap<>();
        assertThat(map.put(null, "00")).isTrue();
        assertThat(map.get(null)).isEqualTo("00");
    }

    @Test
    void whenCheckPutAndThenCollision() {
        assertThat(map.put(37, "37")).isTrue();
        assertThat(map.put(5, "5")).isFalse();
        assertThat(map).containsExactly(1, 2, 3, 4, 37);
        assertThat(map.get(5)).isNull();
    }

    @Test
    void whenCheckDoubleExpand() {
        assertThat(map.put(0, "0")).isTrue();
        assertThat(map.put(8, "8")).isFalse();
    ...
    void whenCheckRemoveAfterExpand() {
        ...
        assertThat(map.put(8, "8")).isTrue();
        assertThat(map).containsExactly(0, 1, 2, 3, 4, 6, 8);
    }

    @Test
    void whenCheckRemoveBeforeAndAfterExpand() {
        assertThat(map.put(0, "0")).isTrue();
        assertThat(map.put(5, "5")).isTrue();
        assertThat(map).hasSize(6);
        assertThat(map.remove(5)).isTrue();
        ...
        assertThat(map).containsExactly(0, 1, 2, 3, 4, 6);
    }
