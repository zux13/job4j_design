...
class CSVReaderTest {
    ...
    @Test
    public void testEmptyCSVFile(@TempDir Path tempDir) throws Exception {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> CSVReader.handle(argsName));
